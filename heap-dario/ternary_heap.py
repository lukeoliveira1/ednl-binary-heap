# Em um heap ternário representado como um array:

# # O nó na posição i tem:
#   - O pai na posição: (i-1) // 3 
#   - O filho esquerdo na posição: 3i + 1 
#   - O filho do meio na posição: 3i + 2 
#   - O filho direito na posição: 3i + 3 
...
class TernaryHeap:
    ...
    def _heapify_down(self, index, heap):
        ...
        while True:
            ...
            middle_child = 3 * index + 2
            right_child = 3 * index + 3
            ...
            if left_child < n and self._is_bigger(left_child, largest, heap):
                largest = left_child
            if middle_child < n and self._is_bigger(middle_child, largest, heap):
    ...
    def change_priority(self, index, new_priority):
        ...
        if index > 0 and self.heap[index] > self.heap[parent]:
            ...
            self._heapify_down(index, self.heap)
        self.display_heap()
